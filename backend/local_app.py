...
#     scaledown_window=15 # model server will remain warm(working/running) for 15 seconds after completion of last request - time in idle mode or shifting to next request
# )
class MusicGenServer :
    ...
    def generate_and_upload_to_S3(
        ...
        image = self.image_pipe(prompt=thumbnail_prompt, guidance_scale=0.0).images[0]
        ...
        # Category Generation : "hip-hop", "rock", etc.
